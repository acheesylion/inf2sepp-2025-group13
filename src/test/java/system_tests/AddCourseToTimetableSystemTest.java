...
public class AddCourseToTimetableSystemTest extends TUITest {
    ...
    @Test
    public void testFullAddCourseToTimetable() throws URISyntaxException, IOException, ParseException {
        setMockInput(
                "0", "COMS10101", "0", "MATH20120", "0", "PHYS10101", "0", "CONF10101","-1", "-1"
        );
    ...
    @Test
    public void invalidCourseCodeAddCourseToTimetable() throws URISyntaxException, IOException, ParseException {
        setMockInput(
                "0", "INF2124", "-1", "-1"
        );
        View view = new TextUserInterface();
    ...
    @Test
    public void addSameCourseTwice() throws URISyntaxException, IOException, ParseException {
        setMockInput(
                "0", "COMS10101", "0", "COMS10101", "-1", "-1"
        );
        View view = new TextUserInterface();
        SharedContext context = new SharedContext(view);
        CourseManager courseManager = context.getCourseManager();
        ...
        startOutputCapture();
        studentController.manageTimetable();
        assertOutputContains("Already added course to timetable");
    }
